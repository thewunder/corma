...
final class ManyToManyHandler extends BaseRelationshipHandler
{
    ...
    public function load(array $objects, RelationshipType|ManyToMany $relationship): array
    {
        if (empty($objects)) {
            return [];
        }
    ...
    public function save(array $objects, RelationshipType|ManyToMany $relationship): void
    {
        if (empty($objects)) {
            return;
        }
